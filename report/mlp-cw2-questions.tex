...
\begin{figure}[t]
    ...
    \begin{subfigure}[t]{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/38_BN_RC_1e2_Loss.pdf} % Replace with your (a) image file
    ...
    \begin{subfigure}[t]{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/38_BN_RC_1e2_Accuracy.pdf} % Replace with your (b) image file
