...
class MNISTDataProvider(DataProvider):
    ...
    def to_one_of_k(self, int_targets):
        """Converts integer coded class targets to 1 of K coded targets.
        ...
        # Get the number of data points (num_data) from the shape of int_targets
        num_data = int_targets.shape[0]
        
        # Create a zero matrix of shape (num_data, num_classes)
        one_hot_targets = np.zeros((num_data, self.num_classes))
        
        # Set the corresponding index to 1 for each target
        one_hot_targets[np.arange(num_data), int_targets] = 1
